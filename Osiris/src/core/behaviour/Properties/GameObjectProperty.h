...
namespace Osiris
{
	class OSR_LIBRARY_API GameObjectProperty : public ScriptProperty
	{
	public:
	...
	private:
		SCRIPT_PROPERTY_FACTORY_SETUP(GameObjectProperty, GameObject*, nullptr, "OsirisAPI.GameObject");
	};
}