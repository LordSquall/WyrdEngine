...
LIBRARY_API void SpriteRenderer_GetColor(void* obj, Wyrd::Color** color);

LIBRARY_API void SpriteRenderer_SetSize(void* obj, float x, float y);

LIBRARY_API void SpriteRenderer_GetSize(void* obj, Wyrd::Vector2* size);

LIBRARY_API void SpriteRenderer_SetPosition(void* obj, float x, float y);

LIBRARY_API void SpriteRenderer_GetPosition(void* obj, Wyrd::Vector2* position);
