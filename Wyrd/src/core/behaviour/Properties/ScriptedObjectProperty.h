...
namespace Wyrd
{
	class WYRD_LIBRARY_API ScriptedObjectProperty : public ScriptProperty
	{
	public:
	...
	private:
		SCRIPT_PROPERTY_FACTORY_SETUP(ScriptedObjectProperty, GameObject*, 0, "WyrdGame.ScriptedObject");
	};
}