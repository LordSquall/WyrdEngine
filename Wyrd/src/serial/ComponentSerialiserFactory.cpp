...
namespace Wyrd
{
	...
	//}
	//
	//void ComponentSerialiserFactory::Serialise(jsonxx::Object& obj, Wyrd::TextComponent* data)
	//{
	...
	{
		std::string name = obj.get<jsonxx::String>("name");
	...
	//}
	//
	//void ComponentSerialiserFactory::Deserialise(jsonxx::Object& obj, Wyrd::TextComponent* data)
	//{
