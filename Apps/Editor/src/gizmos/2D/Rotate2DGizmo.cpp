...
{
    Rotate2DGizmo::Rotate2DGizmo(SceneViewer* sceneViewer) : Gizmo(sceneViewer, ENTITY_INVALID), _XYMoveActive(false)
	{
		/* retrieve the services */
		_EventService = ServiceManager::Get<EventService>();

		/* setup event subscriptions */
		_EventService->Subscribe(Events::EventType::SelectedEntityChanged, WYRD_BIND_FN(Rotate2DGizmo::OnSelectedEntityChanged));
	}

    Rotate2DGizmo::~Rotate2DGizmo() {}
	...
	void Rotate2DGizmo::OnSelectedEntityChanged(Events::EventArgs& args)
	{
    ...
    void Rotate2DGizmo::Build()
    {
        ...
        if (editorComponent != nullptr && transform2DComponent != nullptr)
        {
            ...
            /* origin */
            offset = PrimitiveUtils::GenerateLine(_Vertices, offset, { -10.0f, 0.0f }, { 10.0f, 0.0f }, Color::RED, 2.0f);
            offset = PrimitiveUtils::GenerateLine(_Vertices, offset, { 0.0f, -10.0f }, { 0.0f, 10.0f }, Color::RED, 2.0f);
